...
void paraCima(int matrix[SIZE][SIZE]){/* sobe de cima p baixo, junta de cima pra baixo e sobe:
...
void paraDireita(int matrix[SIZE][SIZE]){/*anda p direita da direita p esquerda, junta da direita p esquerda e anda:*/
      int i,j,k;  /*3*3*4 + 3*4+ 3*4=60 vezes*/
    for(k=0;k<SIZE-1;k++){
        for(j=SIZE-2;j>=0;j--){
    	    for(i=0;i<SIZE;i++){
